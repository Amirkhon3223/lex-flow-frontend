    ...
    <div className="p-3 sm:p-4 md:p-6 space-y-4 sm:space-y-6">
      ...
      <div>
        ...
        <div className="space-y-2 sm:space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4 p-3 sm:p-4 rounded-lg sm:rounded-xl bg-gray-50">
            <div>
              <div className="tracking-tight mb-0.5 sm:mb-1 text-sm sm:text-base">Pro Plan - Октябрь 2025</div>
              <div className="text-xs sm:text-sm text-gray-500">15 октября 2025</div>
            </div>
            <div className="flex items-center justify-between sm:block sm:text-right">
              ...
              <Button
                variant="ghost"
                size="sm"
                className="text-blue-500 hover:bg-blue-50 rounded-lg text-xs sm:text-sm h-7 sm:h-8 px-2"
              >
