  ...
  return (
    <Card>
      <Tabs defaultValue="profile" className="w-full">
        <div className="border-b border-border px-3 sm:px-4 md:px-6 py-3 sm:py-4">
          <TabsList className="bg-muted rounded-lg sm:rounded-xl w-full flex overflow-x-auto">
            <TabsTrigger
              value="profile"
