    ...
    <Card>
      <CardHeader>
        <CardTitle className="text-sm sm:text-base md:text-lg">
          {t('CALENDAR.FIELDS.MEETING_INFO')}
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-3 sm:space-y-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 md:gap-4">
          <InfoBlock
            icon={
              <Clock
                className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-blue-600 dark:text-blue-400"
                strokeWidth={2}
              />
            }
          ...
          {meeting.location && (
            <InfoBlock
              icon={
                <MapPin
                  className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5 text-purple-600 dark:text-purple-400"
                  strokeWidth={2}
                />
              }
        ...
        {meeting.description && (
          <div>
            <h4 className="text-md font-bold text-foreground mb-1.5 sm:mb-2">
