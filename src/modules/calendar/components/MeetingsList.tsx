                ...
                <div className="flex items-start gap-2 mb-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <h4 className="text-sm tracking-tight truncate text-foreground">{meeting.title}</h4>
                        <p className="text-xs text-muted-foreground">{meeting.client.name}</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start justify-between mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">{meeting.client.name}</p>
                      </div>
                    </div>
